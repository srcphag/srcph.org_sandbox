...
(() => {
  var e = {
      763: (e, t, r) => {
        ...
        a.push([
          e.id,
          "body #magicMouseCursor{mix-blend-mode:difference; position:fixed;width:35px;height:35px;border:1px solid #fff;border-radius:0;z-index:9999;left:0;top:0;transition:transform .07s,width .3s,height .3s;pointer-events:none}body #magicMouseCursor.cursor-square{border-radius:0}body #magicPointer{z-index:9999; height:5px;width:5px;top:0;left:0;position:fixed;background:#fff;border-radius:0;pointer-events:none;transition:background .2s,width .2s,height .2s,box-shadow .2s}body #magicPointer.pointer-blur{height:50px;width:50px;background:none;border:1px solid #fff;box-shadow:0px 0px 15px -5px #fff}body #magicPointer.pointer-overlay{height:50px;width:50px;mix-blend-mode:difference;box-shadow:0px 0px 15px -5px #fff}body #magicPointer.is-hover{background:#141414}body .magic-hover{transition:all .2s}body .magic-hover:hover{cursor:none}",
          "",
          {
            version: 3,
            ...
            sourcesContent: [
              "body #magicMouseCursor{position:fixed;width:35px;height:35px;border:1px solid #141414;border-radius:0;z-index:9999;left:0;top:0;transition:transform .07s,width .3s,height .3s;pointer-events:none}body #magicMouseCursor.cursor-square{border-radius:0}body #magicPointer{z-index:9998; height:5px;width:5px;top:0;left:0;position:fixed;background:#fff;border-radius:0;pointer-events:none;transition:background .2s,width .2s,height .2s,box-shadow .2s}body #magicPointer.pointer-blur{height:50px;width:50px;background:none;border:1px solid #fff;box-shadow:0px 0px 15px -5px #fff}body #magicPointer.pointer-overlay{height:50px;width:50px;mix-blend-mode:difference;box-shadow:0px 0px 15px -5px #fff}body #magicPointer.is-hover{background:#141414}body .magic-hover{transition:all .2s}body .magic-hover:hover{cursor:none}",
            ],
            sourceRoot: "",
          },
        ]);
